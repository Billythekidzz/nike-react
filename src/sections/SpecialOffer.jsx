      ...
      <div className="flex flex-1 flex-col">
        <h2 className="mt-10 font-palanquin text-4xl capitalize font-bold lg:max-w-lg">
          ...
          <p className="mt-6 lg:max-w-lg info-text">
            Navigate a realm of possibilities to fulfill your unique desires, surpassing the loftiest expactations. Your journey with us is nothing short of exceptional.
          </p>
